import { HTMLSimplexuiProps, ReactRef, type ImageProps, GenericStyles } from 'core';
...
export declare function useAvatar(props: AvatarProps): {
    ...
    imageStatus: "error" | "idle" | "loading" | "loaded";
    src: string | undefined;
    fallback: ReactNode;
};
export {};
