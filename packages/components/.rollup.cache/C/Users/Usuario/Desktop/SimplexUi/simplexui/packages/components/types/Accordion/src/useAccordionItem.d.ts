import { type HTMLSimplexuiProps, type ReactRef } from 'core';
import { type AccordionItemProps as SimplexAccordionItemProps } from 'simplex_hook';
...
export declare function useAccordionItem(props: AccordionItemProps): {
